    ...
    function (
        ...
        const DBoardMain = function (header, content, footer) {
            ...
            const pr_DATA_CTRL = {
                ...
                [App.router.part.VI_AUT_MAT]: {
                    nameGroup  : "Aut",
                    name       : "AutMat",
                    path       : "group/aut/mat/ctrl/Main",
                    initParams : [null, "#div_main_content", null, "AutMat"],
                    fInit: "do_lc_init",
                    fInitParams: [],
                    fShow      : "do_lc_show",
                    fShowParams: [],
                },
				[App.router.part.VI_AUT_JOB]: {
				                   nameGroup  : "Aut",
				                   name       : "AutJob",
				                   path       : "group/aut/job/ctrl/Main",
				                   initParams : [null, "#div_main_content", null, "AutJob"],
				                   fInit: "do_lc_init",
				                   fInitParams: [],
				                   fShow      : "do_lc_show",
				                   fShowParams: [],
				               },
				[App.router.part.VI_AUT_STD]: {
				                    nameGroup  : "Aut",
				                    name       : "Service",
				                    path       : "group/aut/std/ctrl/Main",
				                    initParams : [null, "#div_main_content", null, "Service"],
				                    fInit: "do_lc_init",
				                    fInitParams: [],
				                    fShow      : "do_lc_show",
				                    fShowParams: [],
				                },
				[App.router.part.VI_MAT_CAT]: {
				                    nameGroup  : "Aut",
				                    name       : "ServiceCat",
				                    path       : "group/mat/ctrl/Main",
				                    initParams : [null, "#div_main_content", null, "ServiceCat"],
				                    fInit: "do_lc_init",
				                    fInitParams: [],
				                    fShow      : "do_lc_show",
				                    fShowParams: [],
