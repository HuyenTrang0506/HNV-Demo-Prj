...
//	}
	...
	public static ResultPagination reqGetInfo (TaAutUser user,  JSONObject json, Integer entTyp, Integer entId) throws Exception {
		...
		if(rs==null || forced) {
			...
			if(list.size() > 0) doBuildDocuments(list);
